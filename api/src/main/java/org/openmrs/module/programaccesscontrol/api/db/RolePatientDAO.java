...
public interface RolePatientDAO {
	...
	/**
	 * @see org.openmrs.module.programaccesscontrol.api.RolePatientService#deleteRolePatients(Role,Patient)
	 */
	public void deleteRolePatient(Role role, Patient patient);
	
	/**
	 * @see org.openmrs.module.programaccesscontrol.api.RolePatientService#getExcludedPatients()
	 */
