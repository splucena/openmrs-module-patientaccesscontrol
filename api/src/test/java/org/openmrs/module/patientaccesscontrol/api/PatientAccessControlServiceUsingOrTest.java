...
public class PatientAccessControlServiceUsingOrTest extends BaseModuleContextSensitiveTest {
	...
	protected static final String OR_DATASET_XML = "org/openmrs/module/" + Constants.MODULE_ID
	        + "/include/initialTestData-Or.xml";
	
	public PatientAccessControlServiceUsingOrTest() {
		super();
	...
	public void getCountOfPatients_shouldReturnTheRightCountWhenAPatientHasMultipleMatchingPersonNames() throws Exception {
		...
		Assert.assertEquals(0, getPatientAccessControlService().getCountOfPatients("").intValue());
	...
	public void getPatients_shouldFindAPatientsWithAMatchingName() throws Exception {
		...
		Context.addProxyPrivilege("View Patients");
		Context.addProxyPrivilege("View Patient Programs");
		Assert.assertEquals(0, getPatientAccessControlService().getPatients("", null, 10).size());
